...
2. **性格分類**: 「DiSC理論」と「アマサイ（アクティブ・マネージ・サービス・イノベーション）」の両軸を用いて、相手の性格タイプを分析・記載してください。
3. **商談シナリオの構成（超重要）**: シナリオは単なる箇条書きを避け、営業がそのままトークとしてイメージできるレベルで肉付けし、**全体で250〜300文字程度**のしっかりとしたボリュームで、必ず以下の「未来・問題・原因・解決」のフレームワークで詳細に描写してください。
...
2. 専門用語を並べるだけでなく、営業マンが明日すぐ使える生きた言葉で出力すること。
